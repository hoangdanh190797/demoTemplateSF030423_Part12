...
const initialState: initialState = {
  ...
  // userAfterJSON: savedUser,
  userOnl: {},
  user: null
}

export const postUserLogin = createAsyncThunk('users/postUserLogin', async (users: any) => {
  try {
...
export const postUserRegister = createAsyncThunk('users/postUserSignup', async (saveUserNew: any) => {
  try {
